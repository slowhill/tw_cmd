            ...
            if (tweetarray.length == 0) {
                ...
                $.each(tweetarray, function(key, value) {
                    ...
                    if (key == (tweetarray.length - 1)) {
                        localStorage.setItem('lastTweetId', value.id_str);
                    } else if (key == 0 && (value.id || value.id_str) > localStorage.newestTweetId) {
                        localStorage.setItem('newestTweetId', value.id);
                    }
                });
